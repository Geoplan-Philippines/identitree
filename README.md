...
- `BETTER_AUTH_URL`: API base URL (for local dev this is usually `http://localhost:8000`)
- `PORT`: set a port, for example `8000`
...
- `NEXT_PUBLIC_API_BASE_URL`: API base URL (for local dev this is usually `http://localhost:8000`)
